	...
	<view style="">
		...
		<div>
			...
			<van-cell-group title="宝贝焕新" v-if="powerKeyList.indexOf('e_nursing') > -1 || powerKeyList.indexOf('e_nursing_wash') > -1">
				<van-cell title="店铺收货" v-if="powerKeyList.indexOf('e_nursing') > -1" is-link @click="goTo('employ/nursing/list')"
				 icon="logistics" />
				<van-cell title="宝贝洗涤" v-if="powerKeyList.indexOf('e_nursing_wash') > -1" is-link @click="goTo('employ/nursing/wash_list')"
				 icon="completed" />
			</van-cell-group>
		</div>
